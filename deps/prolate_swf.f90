...
! -----------------------------------------------------------------------------
! This file is a modified derivative of the original `prolate_swf.f90`
! implementation developed by Arnie Lee Van Buren and Jeffrey Boisvert
...
!      (gauss_cache) to avoid recomputation on repeated calls. Includes:
!      - Type definitions and slot management (48 slots each for pleg/qleg).
