  ...
  subroutine qleg_cached(m, lnum, limq, maxq, x1, ndec, qdr, qdml, iqdml, qdl, iqdl, qr, qml, iqml, ql, iql, termpq, itermpq)
    ...
    if(idx /= 0) then
      ...
      return
                ...
                iflagl1_local = 0
                call qleg(m, lnum, limq, maxq, maxq, x1, ndec, nex_local, iflagl1_local, qdr, &
                                                        qdqr, qdml, iqdml, qdl, iqdl, qr, qml, iqml, ql, iql, termpq, &
...
!
        call main (mmin, minc, mnum, lnum, c, ioprad, iopang, iopnorm, minacc, &
                   ...
                   ir1de, r2c, ir2e, r2dc, ir2de, naccr, s1c, is1e, s1dc, is1de, naccs, naccds, eigout)
!
        end subroutine
!
!
        subroutine main (mmin, minc, mnum, lnum, cc, ioprad, iopang, iopnorm, &
                         ...
                         ir2de, nar, s1, is1, s1d, is1d, nas, nads, eig)
!
