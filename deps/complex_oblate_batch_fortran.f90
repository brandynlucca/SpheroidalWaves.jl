...
contains
  ...
  pure integer(c_int) function solver_lnum(complex_c, requested_lnum) result(adjusted_lnum)
    complex(c_double_complex), intent(in) :: complex_c
    integer(c_int), intent(in) :: requested_lnum
    integer(c_int) :: even_threshold

    adjusted_lnum = requested_lnum
    even_threshold = int((2.0_rk * abs(complex_c)) / acos(-1.0_rk), c_int)
  ...
  subroutine coblate_smn_batch_c8(m, n, c_re, c_im, n_eta, eta, normalize, value_re, value_im, derivative_re, derivative_im, status) bind(C, name="coblate_smn_batch_c8")
  ...
  end subroutine coblate_smn_batch_c8

  subroutine coblate_rmn_batch_c8(m, n, c_re, c_im, n_x, xvec, kind, value_re, value_im, deriv_re, deriv_im, status) bind(C, name="coblate_rmn_batch_c8")
  ...
  end subroutine coblate_rmn_batch_c8

  subroutine coblate_smn_batch_c8_acc(m, n, c_re, c_im, n_eta, eta, normalize, value_re, value_im, derivative_re, derivative_im, naccs_out, status) bind(C, name="coblate_smn_batch_c8_acc")
    integer(c_int), value, intent(in) :: m, n, n_eta, normalize
    real(c_double), value, intent(in) :: c_re, c_im
    real(c_double), intent(in) :: eta(*)
    real(c_double), intent(out) :: value_re(*), value_im(*), derivative_re(*), derivative_im(*)
  ...
  end subroutine coblate_smn_batch_c8_acc

  subroutine coblate_rmn_batch_c8_acc(m, n, c_re, c_im, n_x, xvec, kind, value_re, value_im, deriv_re, deriv_im, naccr_out, status) bind(C, name="coblate_rmn_batch_c8_acc")
    integer(c_int), value, intent(in) :: m, n, n_x, kind
    real(c_double), value, intent(in) :: c_re, c_im
    real(c_double), intent(in) :: xvec(*)
    real(c_double), intent(out) :: value_re(*), value_im(*), deriv_re(*), deriv_im(*)
